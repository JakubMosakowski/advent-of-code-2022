...
private fun main() {
    fun List<String>.move(crateMover: CrateMover): String {
        ...
        val moves = getMoves(separatorIndex).map(Move::from)

        val manipulator = MatrixManipulator(getDrawing(separatorIndex), numberOfStacks, crateMover)
    ...
    fun part1(input: List<String>): String = input.move(CrateMover9000())

    fun part2(input: List<String>): String = input.move(CrateMover9001())
