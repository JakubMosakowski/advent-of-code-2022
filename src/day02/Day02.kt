...
fun main() {
    ...
    fun part1(input: List<String>): Int = input.sumOf { line ->
        ...
        when {
            ...
            opponent == ROCK && response == PAPER_RESPONSE -> WON + PAPER_SCORE
            opponent == ROCK && response == SCISSORS_RESPONSE -> LOOSE + SCISSORS_SCORE
            opponent == PAPER && response == ROCK_RESPONSE -> LOOSE + ROCK_SCORE
            opponent == PAPER && response == PAPER_RESPONSE -> DRAW + PAPER_SCORE
            opponent == PAPER && response == SCISSORS_RESPONSE -> WON + SCISSORS_SCORE
            opponent == SCISSORS && response == ROCK_RESPONSE -> WON + ROCK_SCORE
            opponent == SCISSORS && response == PAPER_RESPONSE -> LOOSE + PAPER_SCORE
            else -> DRAW + SCISSORS_SCORE
        }
    }
